...
<div class="flex h-screen bg-background">
	<div class="flex flex-1 flex-col overflow-hidden px-8 py-6">
		<div class="mb-6">
			...
			<p class="mt-2 text-sm text-muted-foreground">Manage your account settings and preferences</p>
		</div>
				...
				<div class="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
						...
						<div>
							...
							{#if showAddConnection}
								<div class="mt-6 rounded-lg border bg-muted/50 p-4">
									...
									>
										<div>
											<label for="conn-name" class="block text-sm font-medium"> Name </label>
											<input
												id="conn-name"
												type="text"
												bind:value={newConnection.name}
												required
												class="mt-1 block w-full rounded-lg border bg-background px-3 py-2 text-sm focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none"
												placeholder="e.g., OpenAI, Local LLM"
											/>
										</div>
										<div>
											<label for="conn-url" class="block text-sm font-medium"> Base URL </label>
											<input
												id="conn-url"
												type="url"
										...
										<div>
											<label for="conn-key" class="block text-sm font-medium"> API Key </label>
											<input
												id="conn-key"
												type="password"
										...
										<div class="flex items-center gap-2">
											...
											/>
											<label for="isDefault" class="text-sm"> Set as default connection </label>
										</div>
							...
							{#if editingConnection}
								<div class="mt-6 rounded-lg border bg-muted/50 p-4">
									...
									>
										<div>
											<label for="edit-conn-name" class="block text-sm font-medium"> Name </label>
											<input
												id="edit-conn-name"
												type="text"
										...
										<div>
											<label for="edit-conn-key" class="block text-sm font-medium"> API Key </label>
											<input
												id="edit-conn-key"
												type="password"
										...
										<div class="flex items-center gap-2">
											<input
												...
												class="h-4 w-4 rounded border-input text-primary focus:ring-primary"
											/>
											<label for="editIsDefault" class="text-sm"> Set as default connection </label>
										</div>
										<div class="flex gap-2">
											<button
												type="submit"
							...
							>
								<div>
									...
									<input
										...
										class="mt-1 block w-full rounded-lg border bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none"
								...
								<button
									type="submit"
									class="rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none"
								>
									Save Changes
								</button>
							</form>
					...
					{:else if activeTab === 'notifications'}
						<div>
							...
							<p class="mt-1 text-sm text-muted-foreground">Manage how you receive notifications</p>
							...
							<div class="mt-6 space-y-4">
								<div class="flex items-center justify-between">
									...
									<label class="relative inline-flex cursor-pointer items-center">
										...
										/>
										<div
											class="peer h-6 w-11 rounded-full bg-input peer-checked:bg-primary peer-focus:ring-2 peer-focus:ring-ring peer-focus:ring-offset-2 peer-focus:outline-none after:absolute after:top-[2px] after:left-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-border after:bg-background after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-primary-foreground"
										></div>
									</label>
								</div>
